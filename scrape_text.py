...
features = ("gaap","loss","gross profit","cash", "arr", "recurring revenue", "gaap", "churn")
...
def get_scrape_text(cik, form, datea, dateb):
        ...
        try:   
            ...
            for feature in features:
                ...
                if len(final_values)==1:
                    feature_dict[feature] = feature_dict.get(feature,list(final_values)[0])
                elif len(final_values)>1:
                    feature_dict[feature] = feature_dict.get(feature,max(list(final_values)))
        except:
            continue
    for feature in features:
    ...
    return feature_dict
# print(get_scrape_text(78749,"10-K","20210101", "20220101"))